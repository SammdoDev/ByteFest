...
export default function TagTextHeadingPage() {
  return (
    <main className="p-6 max-w-3xl mx-auto">
      <h1 className="text-3xl font-bold text-blue-600 mb-4">Tag Teks & Heading</h1>
...
<p><strong>Strong</strong> & <em>Emphasized</em>.</p>`}</code>
        ...
        <p className="text-gray-700">Contoh tampilan:</p>
        <div className="bg-gray-50 p-4 border rounded text-black">
      ...
      <div className="mt-10 flex justify-between">
        ...
        >
          <FaArrowLeft /> Sebelumnya: Struktur Dasar HTML
        </Link>
        ...
        <Link
          ...
          className="inline-flex items-center gap-2 text-sm text-blue-600 hover:underline"
        >
          Lanjut: Link & Gambar <FaArrowRight />
        </Link>
      </div>
    </main>
  );
